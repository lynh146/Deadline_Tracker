...
// Class Reminder từ hình ảnh đầu tiên
class Reminder {
  final int id;
  final int taskId;
  final DateTime remindAt;

  Reminder({required this.id, required this.taskId, required this.remindAt});
}
...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Future<void> _submit() async {
    ...
    // ADD TASK -> GET REMINDERS -> SCHEDULE NOTIFICATIONS
    final taskId = await TaskService.addTask(task);
    final reminders = await TaskService.getRemindersByTask(taskId);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Tạo task & nhắc nhở thành công')),
    );
